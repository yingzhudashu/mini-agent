...
export const webTools: Record<string, ToolDefinition> = {
  fetch_url: { schema: fetchUrlSchema, handler: fetchUrlHandler, permission: "sandbox", help: "抓取网页内容并提取文本" },
  get_time: { schema: timeSchema, handler: timeHandler, permission: "sandbox", help: "获取当前时间和日期" },
};
